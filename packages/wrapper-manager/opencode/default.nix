...
in {
  wrappers.opencode = {
    # Rewriting Bun's interpreter to Nix glibc breaks networking. Keep the
    # upstream interpreter; NixOS hosts provide it through nix-ld.
    basePackage = opencode-unwrapped;
